...
export default function FragmentExplorer() {
    ...
    if (loading) return <div className="p-8 text-neutral-400">Loading fragments...</div>;
                ...
                <table className="min-w-full divide-y divide-slate-300">
                    <thead className="bg-slate-50">
                        <tr>
                            ...
                            <th className="px-3 py-3.5 text-left text-sm font-semibold text-slate-900">Source</th>
                            <th className="px-3 py-3.5 text-left text-sm font-semibold text-slate-900">Content Preview</th>
