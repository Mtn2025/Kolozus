...
export default function ProductStudio() {
    ...
    if (!product) return <div className="p-10 text-center">Loading Studio...</div>;
        ...
        <div className="h-[calc(100vh-4rem)] flex flex-col bg-white">
            ...
            <div className="h-16 border-b border-slate-200 flex items-center justify-between px-6 bg-slate-50">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-slate-400 mr-2">Editorial Level:</span>
            ...
            <div className="flex-1 flex overflow-hidden relative">
                ...
                <div className="w-80 border-r border-slate-200 bg-slate-50 flex flex-col shrink-0">
                    <div className="p-4 border-b border-slate-200 flex justify-between items-center">
                        <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Structure</span>
                ...
                <div className="flex-1 overflow-y-auto bg-white relative">
                    {activeSection ? (
                            ...
                            <div className="prose prose-slate lg:prose-lg">
                                {activeSection.content ? (
                                    ...
                                    <div className="p-8 border-2 border-dashed border-slate-200 rounded-lg text-center">
                                        <p className="text-slate-500 mb-4">This section is empty.</p>
                                        <button
                                            id="draft-btn"
                                            onClick={handleDraft}
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-slate-400">
                            <p>Select a section to begin writing, or generate a structure.</p>
                        </div>
                    )}
                </div>
                ...
                {showDesign && (
                    <div className="w-80 border-l border-slate-200 bg-white p-6 overflow-y-auto shadow-xl z-10">
                        <h3 className="text-sm font-bold text-slate-900 mb-6 uppercase tracking-wider">Design Specifications</h3>

                        <div className="space-y-6">
                            <div>
                                <label className="block text-xs font-semibold text-slate-700 mb-1">Base Font</label>
                                <select
                                ...
                                >
                                    ...
                                    <option value="'Courier New', monospace">Courier (Draft)</option>
                                </select>
                            </div>
